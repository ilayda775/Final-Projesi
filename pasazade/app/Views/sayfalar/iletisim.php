        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="breadcrumb">
                    <ul>
                        <li><a href="<?=base_url('anasayfa')?>">Anasayfa</a></li>
                        <li>İletişim</li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="contact-info text-center">
                    ...
                    <h4>Adresimiz</h4>
                    <h6>Atatürk mh.No:16B/12/2 Manyas/Balıkesir</h6>
                </div>
            </div>
            <div class="col-md-3">
                <div class="contact-info text-center">
