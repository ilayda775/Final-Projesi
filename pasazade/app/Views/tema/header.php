...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/css/jquery.lineProgressbar.min.css">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="nav-top-access">
                        <!-- Social links -->
                        <ul>
                            <li><i class="fa fa-phone"></i> +90-533-332-65-64</li>
                            <li><i class="fa fa-envelope" aria-hidden="true"></i>  info@pasazade.org</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="logo">
                        ...
                        <a href="<?=base_url('anasayfa')?>">
                            <h3> Paşazade<span>Yapı</span></h3>
                        </a>
                    </div>
                    ...
                    <div class="mainmenu">
                        <nav>
                            <ul id="navigation">
                                ...
                                <li>
                                    <a href="<?=base_url('hizmetler')?>">Hizmetler</a>
                                </li>
                                <li>
